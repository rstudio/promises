...
We can take the syntactic sugar a step further by using the *promise pipe*, a promise-aware version of `%>%` (the magrittr pipe operator). The promise pipe looks like `%then%` and performs most of the same tricks as `%>%`, but adds the functionality of `then`.
