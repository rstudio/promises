...
discussing. See [reference](https://rstudio.github.io/promises/reference/then.html).

And finally, there are `promise_all`, `promise_race`, and `promise_lapply`, used to combine
multiple promises into a single promise. Learn more about them [here](https://rstudio.github.io/promises/reference/promise_all.html).
