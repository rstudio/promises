...
This document will give an introduction to the parts of `future` that are most relevant to promises. For more information, please consult the vignettes that come with `future`, especially the [Comprehensive Overview](https://cran.r-project.org/web/packages/future/vignettes/future-1-overview.html).
