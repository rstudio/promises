...
4. Am I effectively leveraging [reactive programming](https://posit.co/resources/shiny-dev-con/reactivity-pt-1-joe-cheng/) to make sure my reactives are doing as little work as possible?
5. When deploying my app, am I load balancing across multiple R processes and/or multiple servers? ([Shiny Server Pro](https://docs.posit.co/shiny-server/), [RStudio Connect](https://docs.posit.co/connect/admin/appendix/configuration/), [ShinyApps.io](https://shiny.rstudio.com/articles/scaling-and-tuning.html))
