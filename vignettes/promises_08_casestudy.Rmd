...
![Faster response times using asynch served static assets](case-study-gantt-async2.png)
...
![Gantt chart aligned by start time displaying async2 is much better.](case-study-gantt-aligned.png)
