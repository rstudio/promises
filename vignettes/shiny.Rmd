...
Asynchronous reactive expressions are surprisingly similar to regular (synchronous) reactive expressions; instead of a "normal" value, they return a promise that will yield the desired value. A normal reactive will cache a normal value, while an async reactive will cache the promise.
